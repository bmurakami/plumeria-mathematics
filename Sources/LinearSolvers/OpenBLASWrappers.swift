...
public func solveDenseRealLinear_OpenBLAS(_ A: DenseMatrix_Reference<Double>, _ b: DenseVector<Double>) -> DenseVector<Double> {
    ...
    var n = Int32(A.rows)
    var nrhs = Int32(1)
    var matrixA = (A.t as! DenseMatrix_Reference<Double>).flatten()
    ...
    COpenBLAS.dgesv_(&n, &nrhs, &matrixA, &lda, &ipiv, &bCopy, &ldb, &info)
